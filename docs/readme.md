...
│   └── tasks.json ✅
│
├── 📂 data/            # 【本地資料湖】 (Data Lake) 參考後面專門說明的章節
│
...
│   │   │   └── 📂 management/
│   │   │       └── 📂 commmands/
│   │   │           └── seed_settings.py ✅   # 初始化 System 相關資料
│   │   │
...
│       ├── indicator_calc.py
│       ├── market_data.py          # 負責實際的 ETL 與 Parquet 操作 (Service Layer Pattern)
│       └── parquet_manager.py 🚧
│
...
- 禁止在後端業務邏輯中使用 print()，一律使用 logger，以便於 Docker 監控與錯誤追蹤。
